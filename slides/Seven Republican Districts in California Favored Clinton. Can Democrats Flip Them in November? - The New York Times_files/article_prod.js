...
window["optimizely"].push({
  ...
  attributes: {
    ...
    CA: {
        ...
        desk_collapsed_dock: '<strong>Subscribe for $1 (Cdn) a week.</strong> <span style="white-space: nowrap">Ends tomorrow.</span>'
    },
    AU: {
        mobile_collapsed_dock: '<strong>Subscribe for AUD $1 a week.</strong> <span style="white-space: nowrap">Ends tomorrow.</span>',
        desk_collapsed_dock: '<strong>Subscribe for AUD $1 a week.</strong> <span style="white-space: nowrap">Ends tomorrow.</span>'
    }
};

window.nyt5Optly = nyt5Optly;
}}]}], "name": "Variation #1"}], "audienceIds": ["and", "11310120518"], "changes": null, "id": "8504920791", "integrationSettings": null}, {"weightDistributions": null, "audienceName": "[cookie] urgency1", "name": "Sale - Phase 1 - Scheduler", "bucketingStrategy": null, "variations": [{"id": "8501021121", "actions": [{"viewId": "8263601258", "changes": [{"dependencies": [], "type": "custom_code", "id": "8570F1F6-A48C-4E00-A007-347273B97DA4", "value": function($){var nyt5Optly = {
    urgency: 'soon',
    US: '<strong>Subscribe for $1 a week.</strong> <span style="white-space: nowrap">Ends soon.</span>',    
    GB: {
        mobile_collapsed_dock: '<strong>Four-week free trial.</strong> <span style="white-space: nowrap">Ends soon.</span>',
        desk_collapsed_dock: 'Read. Watch. Listen. <strong>Four-week free trial.</strong> <span style="white-space: nowrap">Ends soon.</span>'
    },
    EU: {
        mobile_collapsed_dock: '<strong>Four-week free trial.</strong> <span style="white-space: nowrap">Ends soon.</span>',
        desk_collapsed_dock: 'Read. Watch. Listen. <strong>Four-week free trial.</strong> <span style="white-space: nowrap">Ends soon.</span>'
    ...
    CA: {
        mobile_collapsed_dock: '<strong>Subscribe for $1 (Cdn) a week.</strong> <span style="white-space: nowrap">Limited time offer.</span>',
        desk_collapsed_dock: '<strong>Subscribe for $1 (Cdn) a week.</strong> <span style="white-space: nowrap">Limited time offer.</span>'
    },
    AU: {
        mobile_collapsed_dock: '<strong>Subscribe for AUD $1 a week.</strong> <span style="white-space: nowrap">Limited time offer.</span>',
        desk_collapsed_dock: '<strong>Subscribe for AUD $1 a week.</strong> <span style="white-space: nowrap">Limited time offer.</span>'
    }
};

window.nyt5Optly = nyt5Optly;
}}]}], "name": "Variation #1"}], "audienceIds": ["and", "11348210295"], "changes": null, "id": "8508672989", "integrationSettings": null}, {"weightDistributions": null, "audienceName": "[cookie] urgency3", "name": "Sale - Phase 3 - Scheduler", "bucketingStrategy": null, "variations": [{"id": "11326772976", "actions": [{"viewId": "8263601258", "changes": [{"dependencies": [], "type": "custom_code", "id": "8570F1F6-A48C-4E00-A007-347273B97DA4", "value": function($){var nyt5Optly = {
    urgency: 'today',
    ...
    CA: {
        ...
        desk_collapsed_dock: '<strong>Subscribe for $1 (Cdn) a week.</strong> <span style="white-space: nowrap">Ends today.</span>'
    },
    AU: {
        mobile_collapsed_dock: '<strong>Subscribe for AUD $1 a week.</strong> <span style="white-space: nowrap">Ends today.</span>',
        desk_collapsed_dock: '<strong>Subscribe for AUD $1 a week.</strong> <span style="white-space: nowrap">Ends today.</span>'
    }
};

window.nyt5Optly = nyt5Optly;
}}]}], "name": "Variation #1"}], "audienceIds": ["and", "11315503751"], "changes": null, "id": "11347113416", "integrationSettings": null}, {"weightDistributions": null, "audienceName": "[cookie] urgency2edu", "name": "EDU Sale - Phase 2 - Scheduler", "bucketingStrategy": null, "variations": [{"id": "11376803827", "actions": [{"viewId": "8263601258", "changes": [{"dependencies": [], "type": "custom_code", "id": "8570F1F6-A48C-4E00-A007-347273B97DA4", "value": function($){var nyt5Optly = {
    urgency: 'soon'    
};

window.nyt5Optly = nyt5Optly;
}}]}], "name": "Variation #1"}], "audienceIds": ["and", "11378686743"], "changes": null, "id": "11367005292", "integrationSettings": null}], "id": "8424090827", "weightDistributions": null, "name": "Scheduled Copy Change Management and Ad Ops Support", "groupId": null, "commitId": "11394703152", "decisionMetadata": {"experimentPriorities": [[{"entityId": "11367005292", "endOfRange": null}], [{"entityId": "8508672989", "endOfRange": null}], [{"entityId": "8504920791", "endOfRange": null}], [{"entityId": "11347113416", "endOfRange": null}]], "offerConsistency": null}, "policy": "equal_priority", "changes": null}, {"holdback": 0, "activation": {}, "integrationSettings": {}, "integrationStringVersion": 2, "viewIds": ["6252880791", "8263601258"], "experiments": [{"weightDistributions": null, "audienceName": "[cookie] urgency1", "name": "NYT5 INYT & US sale Ends tomorrow", "bucketingStrategy": null, "variations": [{"id": "11181863902", "actions": [{"viewId": "8263601258", "changes": [{"value": function($){var exoOptly = {
    urgency: 'tomorrow',
    US: '<strong>Subscribe for $1 a week.</strong> <span style="white-space: nowrap">Ends tomorrow.</span>',    
    UK: {
        mobile_collapsed_dock: '<strong>Four-week free trial.</strong> <span style="white-space: nowrap">Ends tomorrow.</span>',
...
runWhenReady(function () {
  ...
  NYTD.Abra.reportExposure('MKT_wm_offer_fm_dfp_0718');
}, 1000, 10);
...
PluginManager.registerAnalyticsTracker('11081220413', {
  ...
  function getPlacementName(data) {
    ...
    var name = placements.filter(function(el) {
