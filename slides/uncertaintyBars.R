...
arrows(c(0.5, 1.5, 2.5), lower1, c(0.5, 1.5, 2.5), pmin(1, upper1), length=0)
arrows(c(0.5, 1.5, 2.5)-0.25, pmax(0, lower1), c(0.5, 1.5, 2.5)+0.25, pmax(0,lower1), length=0)
arrows(c(0.5, 1.5, 2.5)-0.25, pmin(1,upper1), c(0.5, 1.5, 2.5)+0.25, pmin(1,upper1), length=0)



upper2 = props2 + 1.96*sqrt(props2*(1-props2)/38)
lower2 = props2 - 1.96*sqrt(props2*(1-props2)/38)
